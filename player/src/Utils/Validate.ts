...
export class Validate {
	 ...
	 */
	public static number(input: number | undefined, inputName: string, min: number | undefined = undefined, mayBeUndefined: boolean = false, mayBeNull: boolean = mayBeUndefined): void {
		if (input !== undefined) {
	 ...
	 */
	public static string(input: string | undefined | null, inputName: string, minLength: number | undefined = undefined, maxLength: number | undefined = undefined, mayBeUndefined: boolean = false, mayBeNull: boolean = mayBeUndefined): void {
	 ...
	 */
	public static date(input: string | undefined, inputName: string, minLength: number | undefined = undefined, maxLength: number | undefined = undefined, mayBeUndefined: boolean = false, mayBeNull: boolean = mayBeUndefined): void {
		if (input !== undefined) {
			var length = input.length;
			if (minLength !== undefined && length < minLength)
				throw new ValidationException(inputName, `The string "${inputName}" has to be at least ${minLength} characters long, but it has a length of ${input}.`);
