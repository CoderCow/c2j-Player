...
export class OverlayManager {
	...
	public constructor(player: VideoJSPlayer, videoData: VideoData, initialLanguage: string) {
		...
		this._overlayContainer = $(vtreeToDomElement(<div class="overlay-container"></div>));
	...
	public setLanguage(languageCode: string) {
		...
		for (var i = 0; i < overlays.length; i++) {
			this._overlays[i] = new OverlayComponent(this._player, {
	...
	public removeAllOverlays() {
		...
		this._pausingOverlay = undefined;
	}
	...
	private player_play() {
		if (this._pausingOverlay !== undefined) {
