import { NotesMarkerMenuItemComponent } from './NotesMarkerMenuItemComponent';
...
import { INotesMarkerComponentOptions } from './INotesMarkerComponentOptions';
import { INoteData } from './../../Data/VideoData/INoteData';
import { MenuMarkerComponent } from './../Buttons/MenuMarkerComponent';
...
export class NotesMarkerComponent extends MenuMarkerComponent {
	...
	public cjOptions(): INotesMarkerComponentOptions {
		return super.cjOptions() as INotesMarkerComponentOptions;
	}
}
