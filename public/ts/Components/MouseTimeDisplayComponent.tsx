...
export class MouseTimeDisplayComponent extends VideoJSComponent {
	...
	public createEl(tagName: string, properties?: any, attributes?: any) {
		return vtreeToDomElement(<div className="vjs-mouse-display"></div>);
	}
	...
	private update(newTime: number, position: number, pointElement: Element) {
		var shouldShowMouseText = (pointElement.getAttribute("data-hide-mousetext") === null);
		if (pointElement !== undefined && shouldShowMouseText) {
			var tooltipString: string | null;
			tooltipString = pointElement.getAttribute("data-mousetext");
			if (tooltipString === null || tooltipString === undefined)
...
videojs.registerComponent('MouseTimeDisplayComponent', MouseTimeDisplayComponent);
