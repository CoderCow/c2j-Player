...
import { ILanguageButtonOptions } from './ILanguageButtonOptions';
...
export class LanguageButtonComponent extends VideoJSMenuButton {
	...
	public constructor(player: VideoJSPlayer, options: ILanguageButtonOptions) {
	...
	public cjOptions(): ILanguageButtonOptions {
