...
import { IChapterMarkerOptions } from './IChapterMarkerOptions';
...
export class ChapterMarkerComponent extends VideoJSComponent {
	...
	public constructor(player: VideoJSPlayer, options: IChapterMarkerOptions) {
	...
	public cjOptions(): IChapterMarkerOptions {
