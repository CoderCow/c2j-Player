...
import { CaptionData } from './Data/VideoData/CaptionData';
...
export class SubtitleManager {
	...
	public constructor(player: VideoJSPlayer, videoJSManager: VideoJSManager, initialLanguage: string | undefined = undefined) {
		this._player = player;
		...
		$.each(videoJSManager.videoData.captions, (languageCode: string, captions: CaptionData[]) => {
			languageCode = Utils.normalizeLanguageCode(languageCode);
