import { OverlaySettingsData } from './../VideoData/OverlaySettingsData';
import { Vector3 } from './../../Utils/Vector3';
import { AuthCamData } from './../VideoData/AuthCamData';
import { OverlayData, LinkActionParamsData, GotoActionParamsData, OverlayAction } from './../VideoData/OverlayData';
import { LinkData } from './../VideoData/LinkData';
import { ChapterAdditionalData } from './../VideoData/ChapterAdditionalData';
import { ChapterData } from './../VideoData/ChapterData';
import { AuthorNoteData } from './../VideoData/AuthorNoteData';
import { CategoryData } from './../VideoData/CategoryData';
import { CaptionData } from './../VideoData/CaptionData';
import { CaptionSettingsData } from './../VideoData/CaptionSettingsData';
import { MediumData } from './../VideoData/MediumData';
import { ICamtasia2JsonData } from './../ICamtasia2JsonData';
...
export class Camtasia2JsonReader {
	...
	private static overlaysFromJsonData(jsonData: ICamtasia2JsonData): LanguageDictionary<OverlayData[]> {
		...
		jsonData.overlays.forEach((item: any) => {
			...
			if (overlayData.action === OverlayAction.OpenLink)
				...
				overlayData.actionParams = undefined;
	 ...
	 * with their language tags as keys.
	 */
	private static authCamFromJsonData(jsonData: ICamtasia2JsonData): AuthCamData | undefined {
